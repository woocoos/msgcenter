...
export type UserRootOrgsQuery = { __typename?: 'Query', userRootOrgs: Array<{ __typename?: 'Org', id: string, parentID: string, code?: string | null, name: string, displaySort?: number | null, countryCode?: string | null, timezone?: string | null }> };
